...
public class PartitionData implements Runnable {
    ...
    /**
     * Partitions the datat into two equals as possible stacks 
     * 
     * @param nValues the number of values to partition
     * @param nSteps the number of Monte Carlo steps to take
     * 
     */
